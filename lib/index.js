...
API.prototype.listActions = function(cb) {
  ...
  return this._paginatedRequest(qry, 'actions', cb);
};
...
API.prototype.listDomains = function(cb) {
  ...
  return this._paginatedRequest(qry, 'domains', cb);
};
...
API.prototype.listDroplets = function(cb) {
  var qry = {
    method: 'GET',
    target: 'droplets',
  };
  return this._paginatedRequest(qry, 'droplets', cb);
};

API.prototype.getDroplet = function(id, cb) {
  this._regularRequest({
    method: 'GET',
    target: 'droplets/'+id
  }, 'droplet', cb);
...
API.prototype.listAvailableKernels = function(id, cb) {
  var qry = {
    method: 'GET',
    target: 'droplets/'+id+'/kernels',
  };
  return this._paginatedRequest(qry, 'kernels', cb);
};

API.prototype.getDropletSnapshots = function(id, cb) {
  var qry = {
    method: 'GET',
    target: 'droplets/'+id+'/snapshots',
  };
  return this._paginatedRequest(qry, 'snapshots', cb);
};

API.prototype.getDropletBackups = function(id, cb) {
  var qry = {
    method: 'GET',
    target: 'droplets/'+id+'/backups',
  };
  return this._paginatedRequest(qry, 'backups', cb);
};

API.prototype.getDropletActions = function(id, cb) {
  var qry = {
    method: 'GET',
...
API.prototype.deleteDroplet = function(id, cb) {
  this._regularRequest({
    method: 'DELETE',
    target: 'droplets/'+id
  }, 'droplet', function(err, body, response) {
    if (err)
      return cb(err);
...
API.prototype.listRegions = function(cb) {
  this._regularRequest({
    method: 'GET',
    target: 'regions'
  }, 'regions', cb);
